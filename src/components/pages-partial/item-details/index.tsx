...
export default function PartialItemDetails() {
  return (
    <AppLayout>
      <div className="flex flex-col self-stretch w-full gap-y-4 overflow-y-scroll xs:mb-16 lg:my-16">
        <div className="flex flex-col justify-center items-center ">
          <h1 className="text-center px-4 text-3xl font-semibold">
            Add Gold & Sliver Items
          </h1>
          <span className="text-center px-4 font-normal text-lg mt-2 leading-6 mb-2">
