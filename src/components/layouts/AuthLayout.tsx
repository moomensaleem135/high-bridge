...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className="flex flex-col lg:flex-row py-0 lg:pr-[7rem] xl:pl-[15rem] lg:pl-[8rem] items-center w-screen h-screen max-lg:my-10 overflow-y-auto overflow-x-hidden lg:pt-40 lg:pb-20 xl:py-0">
