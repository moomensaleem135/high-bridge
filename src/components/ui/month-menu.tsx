      ...
      {calendar === 'lunar' ? (
        <div className="absolute bg-white w-[27.4%] top-[32.8rem] rounded-md h-[40vh] overflow-auto">
          <ul className="h-full flex flex-col justify-start items-center">
            <li
              className="w-full h-[10%] flex justify-start items-center gap-2 rounded-t-md p-2 hover:bg-DropdownHover"
            ...
            <li
              className="w-full h-[10%] flex justify-start items-center gap-2 rounded-md p-2 hover:bg-DropdownHover"
            ...
            <li
              className="w-full h-[10%] flex justify-start items-center gap-2 rounded-b-md p-2 hover:bg-DropdownHover"
